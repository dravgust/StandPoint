...
namespace StandPoint.Utilities
{
    ...
    public class AsyncLoop : IAsyncLoop
    {
        ...
        public IAsyncLoop Run(CancellationToken cancellation, TimeSpan? repeatEvery = null, TimeSpan? startAfter = null)
        {
            ...
            this.RunningTask = StartAsync(cancellation, repeatEvery ?? TimeSpan.FromMilliseconds(1000), startAfter);
        ...
        private Task StartAsync(CancellationToken cancellation, TimeSpan refreshRate, TimeSpan? delayStart = null)
        {
            return Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    {
                        await _loopAsync(cancellation).ConfigureAwait(false);
                ...
                if (uncaughtException != null)
                {
                    ...
                    _logger.LogCritical(new EventId(0), uncaughtException, Name + " threw an unhandled exception");

                    // You can touch this one.
                    _logger.LogDebug("{0} threw an unhandled exception: {1}", this.Name, uncaughtException.ToString());
                }
            }, cancellation);
        }
        ...
        public void Dispose()
        {
            ...
            {
                this._logger.LogInformation("Waiting for {0} to finish.", this.Name);
